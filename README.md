...
| 03.|[What is Hoisting?](#q-what-is-hoisting)|
...
| 07.|[What is prototype chain?](#q-what-is-prototype-chain)|
| 08.|[What is the difference between Call, Apply and Bind?](#q-what-is-the-difference-between-call-apply-and-bind)|
| 09.|[What is the difference between == and === operators?](#q-what-is-the-difference-between-and-operators)|
| 10.|[What is a first class function?](#q-what-is-a-first-class-function)|
| 11.|[What is a first order function?](#q-what-is-a-first-order-function)|
| 12.|[What is a higher order function?](#q-what-is-a-higher-order-function)|
| 13.|[What is a unary function?](#q-what-is-a-unary-function)|
| 14.|[What is currying function?](#q-what-is-currying-function)|
| 15.|[What is a pure function?](#q-what-is-a-pure-function)|
| 16.|[What is memoization?](#q-what-is-memoization)|
| 17.|[What is a service worker?](#q-what-is-a-service-worker)|
| 18.|[How do you manipulate DOM using service worker?](#q-how-do-you-manipulate-dom-using-service-worker)|
| 19.|[How do you reuse information across service worker restarts?](#q-how-do-you-reuse-information-across-service-worker-restarts)|
| 20.|[What is IndexedDB?](#q-what-is-indexeddb)|
| 21.|[What is web storage?](#q-what-is-web-storage)|
| 22.|[What is a post message?](#q-what-is-a-post-message)|
| 23.|[What is a Cookie?](#q-what-is-a-cookie)|
| 24.|[How do you delete a cookie?](#q-how-do-you-delete-a-cookie)|
| 25.|[How do you access web storage?](#q-how-do-you-access-web-storage)|
| 26.|[What are the methods available on session storage?](#q-what-are-the-methods-available-on-session-storage)|
| 27.|[What is a storage event and its event handler?](#q-what-is-a-storage-event-and-its-event-handler)|
| 28.|[How do you check web storage browser support?](#q-how-do-you-check-web-storage-browser-support)|
| 29.|[Give an example of web worker?](#q-give-an-example-of-web-worker)|
| 30.|[What are the restrictions of web workers on DOM?](#q-what-are-the-restrictions-of-web-workers-on-dom)|
| 31.|[What is a promise?](#q-what-is-a-promise)|
| 32.|[What is a callback function?](#q-what-is-a-callback-function)|
| 33.|[Why do we need callbacks?](#q-why-do-we-need-callbacks)|
| 34.|[What is a callback hell?](#q-what-is-a-callback-hell)|
| 35.|[What is server-sent events?](#q-what-is-server-sent-events)|
| 36.|[How do you receive server-sent event notifications?](#q-how-do-you-receive-server-sent-event-notifications)|
| 37.|[What are the events available for server sent events?](#q-what-are-the-events-available-for-server-sent-events)|
| 38.|[What are the main rules of promise?](#q-what-are-the-main-rules-of-promise)|
| 39.|[What is callback in callback?](#q-what-is-callback-in-callback)|
| 40.|[What is promise chaining?](#q-what-is-promise-chaining)|
| 41.|[What is promise.all?](#q-what-is-promiseall)|
| 42.|[What is the purpose of race method in promise?](#q-what-is-the-purpose-of-race-method-in-promise)|
| 43.|[What is a strict mode in javascript?](#q-what-is-a-strict-mode-in-javascript)|
| 44.|[Why do you need strict mode?](#q-why-do-you-need-strict-mode)|
| 45.|[How do you declare strict mode?](#q-how-do-you-declare-strict-mode)|
| 46.|[What is the purpose of double exclamation?](#q-what-is-the-purpose-of-double-exclamation)|
| 47.|[What is the purpose of delete operator?](#q-what-is-the-purpose-of-delete-operator)|
| 48.|[What is typeof operator?](#q-what-is-typeof-operator)|
| 49.|[What is undefined property?](#q-what-is-undefined-property)|
| 50.|[What is the difference between null and undefined?](#q-what-is-the-difference-between-null-and-undefined)|
| 51.|[What is eval?](#q-what-is-eval)|
| 52.|[What is the difference between window and document?](#q-what-is-the-difference-between-window-and-document)|
| 53.|[How do you access history in javascript?](#q-how-do-you-access-history-in-javascript)|
| 54.|[What are the javascript data types?](#q-what-are-the-javascript-data-types)|
| 55.|[What is isNaN?](#q-what-is-isnan)|
| 56.|[What are the differences between undeclared and undefined variables?](#q-what-are-the-differences-between-undeclared-and-undefined-variables)|
| 57.|[What are global variables?](#q-what-are-global-variables)|
| 58.|[What is NaN property?](#q-what-is-nan-property)|
| 59.|[What is the purpose of isFinite function?](#q-what-is-the-purpose-of-isfinite-function)|
| 60.|[What is an event flow?](#q-what-is-an-event-flow)|
| 61.|[What is event bubbling?](#q-what-is-event-bubbling)|
| 62.|[What is event capturing?](#q-what-is-event-capturing)|
| 63.|[How do you submit a form using JavaScript?](#q-how-do-you-submit-a-form-using-javascript)|
| 64.|[How do you find operating system details?](#q-how-do-you-find-operating-system-details)|
| 65.|[What is the difference between document load and DOMContentLoaded events?](#q-what-is-the-difference-between-document-load-and-domcontentloaded-events)|
| 66.|[What is the difference between native, host and user objects?](#q-what-is-the-difference-between-native-host-and-user-objects)|
| 67.|[What are the pros and cons of promises over callbacks?](#q-what-are-the-pros-and-cons-of-promises-over-callbacks)|
| 68.|[What is the difference between an attribute and a property?](#q-what-is-the-difference-between-an-attribute-and-a-property)|
| 69.|[What is same-origin policy?](#q-what-is-same-origin-policy)|
| 70.|[What is the purpose of void 0?](#q-what-is-the-purpose-of-void-0)|
| 71.|[Is JavaScript a compiled or interpreted language?](#q-is-javascript-a-compiled-or-interpreted-language)|
| 72.|[Is JavaScript a case-sensitive language?](#q-is-javascript-a-case-sensitive-language)|
| 73.|[What are events?](#q-what-are-events)|
| 74.|[What is the use of preventDefault method?](#q-what-is-the-use-of-preventdefault-method)|
| 75.|[What is the use of stopPropagation method?](#q-what-is-the-use-of-stoppropagation-method)|
| 76.|[What are the steps involved in return false usage?](#q-what-are-the-steps-involved-in-return-false-usage)|
| 77.|[What is BOM?](#q-what-is-bom)|
| 78.|[What is the use of setTimeout?](#q-what-is-the-use-of-settimeout)|
| 79.|[What is the use of setInterval?](#q-what-is-the-use-of-setinterval)|
| 80.|[Why is JavaScript treated as Single threaded?](#q-why-is-javascript-treated-as-single-threaded)|
| 81.|[What is an event delegation?](#q-what-is-an-event-delegation)|
| 82.|[What is ECMAScript?](#q-what-is-ecmascript)|
| 83.|[What is JSON?](#q-what-is-json)|
| 84.|[What are the syntax rules of JSON?](#q-what-are-the-syntax-rules-of-json)|
| 85.|[What is the purpose JSON stringify?](#q-what-is-the-purpose-json-stringify)|
| 86.|[How do you parse JSON string?](#q-how-do-you-parse-json-string)|
| 87.|[Why do you need JSON?](#q-why-do-you-need-json)|
| 88.|[What is the purpose of clearTimeout method?](#q-what-is-the-purpose-of-cleartimeout-method)|
| 89.|[What is the purpose of clearInterval method?](#q-what-is-the-purpose-of-clearinterval-method)|
| 90.|[How do you redirect new page in javascript?](#q-how-do-you-redirect-new-page-in-javascript)|
| 91.|[How do you check whether a string contains a substring?](#q-how-do-you-check-whether-a-string-contains-a-substring)|
| 92.|[How do you validate an email in javascript?](#q-how-do-you-validate-an-email-in-javascript)|
| 93.|[How do you get the current url with javascript?](#q-how-do-you-get-the-current-url-with-javascript)|
| 94.|[What are the various url properties of location object?](#q-what-are-the-various-url-properties-of-location-object)|
| 95.|[How do get query string values in javascript?](#q-how-do-get-query-string-values-in-javascript)|
| 96.|[How do you check if a key exists in an object?](#q-how-do-you-check-if-a-key-exists-in-an-object)|
| 97.|[How do you loop through or enumerate javascript object?](#q-how-do-you-loop-through-or-enumerate-javascript-object)|
| 98.|[How do you test for an empty object?](#q-how-do-you-test-for-an-empty-object)|
| 99.|[What is an arguments object?](#q-what-is-an-arguments-object)|
| 100.|[How do you make first letter of the string in an uppercase?](#q-how-do-you-make-first-letter-of-the-string-in-an-uppercase)|
| 101.|[What are the pros and cons of for loop?](#q-what-are-the-pros-and-cons-of-for-loop)|
| 102.|[How do you display the current date in javascript?](#q-how-do-you-display-the-current-date-in-javascript)|
| 103.|[How do you compare two date objects?](#q-how-do-you-compare-two-date-objects)|
| 104.|[How do you check if a string starts with another string?](#q-how-do-you-check-if-a-string-starts-with-another-string)|
| 105.|[How do you trim a string in javascript?](#q-how-do-you-trim-a-string-in-javascript)|
| 106.|[How do you add a key value pair in javascript?](#q-how-do-you-add-a-key-value-pair-in-javascript)|
| 107.|[Is the !-- notation represents a special operator?](#q-is-the-notation-represents-a-special-operator)|
| 108.|[How do you assign default values to variables?](#q-how-do-you-assign-default-values-to-variables)|
| 109.|[How do you define multiline strings?](#q-how-do-you-define-multiline-strings)|
| 110.|[Can we define properties for functions?](#q-can-we-define-properties-for-functions)|
| 111.|[What is the way to find the number of parameters expected by a function?](#q-what-is-the-way-to-find-the-number-of-parameters-expected-by-a-function)|
| 112.|[What are break and continue statements?](#q-what-are-break-and-continue-statements)|
| 113.|[What are js labels?](#q-what-are-js-labels)|
| 114.|[What are the benefits of keeping declarations at the top?](#q-what-are-the-benefits-of-keeping-declarations-at-the-top)|
| 115.|[What are the benefits of initializing variables?](#q-what-are-the-benefits-of-initializing-variables)|
| 116.|[What are the recommendations to create new object?](#q-what-are-the-recommendations-to-create-new-object)|
| 117.|[How do you define JSON arrays?](#q-how-do-you-define-json-arrays)|
| 118.|[How do you generate random integers?](#q-how-do-you-generate-random-integers)|
| 119.|[Can you write a random integers function to print integers with in a range?](#q-can-you-write-a-random-integers-function-to-print-integers-with-in-a-range)|
| 120.|[What are the string methods available in Regular expression?](#q-what-are-the-string-methods-available-in-regular-expression)|
| 121.|[What are modifiers in regular expression?](#q-what-are-modifiers-in-regular-expression)|
| 122.|[What are regular expression patterns?](#q-what-are-regular-expression-patterns)|
| 123.|[What is a RegExp object?](#q-what-is-a-regexp-object)|
| 124.|[How do you search a string for a pattern?](#q-how-do-you-search-a-string-for-a-pattern)|
| 125.|[What is the purpose of exec method?](#q-what-is-the-purpose-of-exec-method)|
| 126.|[How do you change style of a HTML element?](#q-how-do-you-change-style-of-a-html-element)|
| 127.|[What is a debugger statement?](#q-what-is-a-debugger-statement)|
| 128.|[What is the purpose of breakpoints in debugging?](#q-what-is-the-purpose-of-breakpoints-in-debugging)|
| 129.|[Can I use reserved words as identifiers?](#q-can-i-use-reserved-words-as-identifiers)|
| 130.|[How do you detect a mobile browser without regexp?](#q-how-do-you-detect-a-mobile-browser-without-regexp)|
| 131.|[How do you get the image width and height using JS?](#q-how-do-you-get-the-image-width-and-height-using-js)|
| 132.|[How do you make synchronous HTTP request?](#q-how-do-you-make-synchronous-http-request)|
| 133.|[How do you make asynchronous HTTP request?](#q-how-do-you-make-asynchronous-http-request)|
| 134.|[How do you convert date to another timezone in javascript?](#q-how-do-you-convert-date-to-another-timezone-in-javascript)|
| 135.|[What are the properties used to get size of window?](#q-what-are-the-properties-used-to-get-size-of-window)|
| 136.|[What is a conditional operator in javascript?](#q-what-is-a-conditional-operator-in-javascript)|
| 137.|[Can you apply chaining on conditional operator?](#q-can-you-apply-chaining-on-conditional-operator)|
| 138.|[What are the ways to execute javascript after page load?](#q-what-are-the-ways-to-execute-javascript-after-page-load)|
| 139.|[What is the difference between proto and prototype?](#q-what-is-the-difference-between-proto-and-prototype)|
| 140.|[Give an example where do you really need semicolon?](#q-give-an-example-where-do-you-really-need-semicolon)|
| 141.|[What is a freeze method?](#q-what-is-a-freeze-method)|
| 142.|[What is the purpose of freeze method?](#q-what-is-the-purpose-of-freeze-method)|
| 143.|[Why do I need to use freeze method?](#q-why-do-i-need-to-use-freeze-method)|
| 144.|[How do you detect a browser language preference?](#q-how-do-you-detect-a-browser-language-preference)|
| 145.|[How to convert string to title case with javascript?](#q-how-to-convert-string-to-title-case-with-javascript)|
| 146.|[How do you detect javascript disabled in the page?](#q-how-do-you-detect-javascript-disabled-in-the-page)|
| 147.|[What are various operators supported by javascript?](#q-what-are-various-operators-supported-by-javascript)|
| 148.|[What is a rest parameter?](#q-what-is-a-rest-parameter)|
| 149.|[What happens if you do not use rest parameter as a last argument?](#q-what-happens-if-you-do-not-use-rest-parameter-as-a-last-argument)|
| 150.|[What are the bitwise operators available in javascript?](#q-what-are-the-bitwise-operators-available-in-javascript)|
| 151.|[How do you determine whether object is frozen or not?](#q-how-do-you-determine-whether-object-is-frozen-or-not)|
| 152.|[How do you determine two values same or not using object?](#q-how-do-you-determine-two-values-same-or-not-using-object)|
| 153.|[What is the purpose of using object is method?](#q-what-is-the-purpose-of-using-object-is-method)|
| 154.|[How do you copy properties from one object to other?](#q-how-do-you-copy-properties-from-one-object-to-other)|
| 155.|[What are the applications of assign method?](#q-what-are-the-applications-of-assign-method)|
| 156.|[What is a proxy object?](#q-what-is-a-proxy-object)|
| 157.|[What is the purpose of seal method?](#q-what-is-the-purpose-of-seal-method)|
| 158.|[What are the applications of seal method?](#q-what-are-the-applications-of-seal-method)|
| 159.|[What are the differences between freeze and seal methods?](#q-what-are-the-differences-between-freeze-and-seal-methods)|
| 160.|[How do you determine if an object is sealed or not?](#q-how-do-you-determine-if-an-object-is-sealed-or-not)|
| 161.|[How do you get enumerable key and value pairs?](#q-how-do-you-get-enumerable-key-and-value-pairs)|
| 162.|[What is the main difference between Object.values and Object.entries method?](#q-what-is-the-main-difference-between-objectvalues-and-objectentries-method)|
| 163.|[How can you get the list of keys of any object?](#q-how-can-you-get-the-list-of-keys-of-any-object)|
| 164.|[How do you create an object with prototype?](#q-how-do-you-create-an-object-with-prototype)|
| 165.|[What is a WeakSet?](#q-what-is-a-weakset)|
| 166.|[What are the differences between WeakSet and Set?](#q-what-are-the-differences-between-weakset-and-set)|
| 167.|[List down the collection of methods available on WeakSet?](#q-list-down-the-collection-of-methods-available-on-weakset)|
| 168.|[What is a WeakMap?](#q-what-is-a-weakmap)|
| 169.|[What are the differences between WeakMap and Map?](#q-what-are-the-differences-between-weakmap-and-map)|
| 170.|[List down the collection of methods available on WeakMap?](#q-list-down-the-collection-of-methods-available-on-weakmap)|
| 171.|[What is the purpose of uneval?](#q-what-is-the-purpose-of-uneval)|
| 172.|[How do you encode an URL?](#q-how-do-you-encode-an-url)|
| 173.|[How do you decode an URL?](#q-how-do-you-decode-an-url)|
| 174.|[How do you print the contents of web page?](#q-how-do-you-print-the-contents-of-web-page)|
| 175.|[What is the difference between uneval and eval?](#q-what-is-the-difference-between-uneval-and-eval)|
| 176.|[What is an anonymous function?](#q-what-is-an-anonymous-function)|
| 177.|[What is the precedence order between local and global variables?](#q-what-is-the-precedence-order-between-local-and-global-variables)|
| 178.|[What are javascript accessors?](#q-what-are-javascript-accessors)|
| 179.|[How do you define property on Object constructor?](#q-how-do-you-define-property-on-object-constructor)|
| 180.|[What is the difference between get and defineProperty?](#q-what-is-the-difference-between-get-and-defineproperty)|
| 181.|[What are the advantages of Getters and Setters?](#q-what-are-the-advantages-of-getters-and-setters)|
| 182.|[Can I add getters and setters using defineProperty method?](#q-can-i-add-getters-and-setters-using-defineproperty-method)|
| 183.|[What is the purpose of switch-case?](#q-what-is-the-purpose-of-switch-case)|
| 184.|[What are the conventions to be followed for the usage of swtich case?](#q-what-are-the-conventions-to-be-followed-for-the-usage-of-swtich-case)|
| 185.|[What are the different ways to access object properties?](#q-what-are-the-different-ways-to-access-object-properties)|
| 186.|[What are the function parameter rules?](#q-what-are-the-function-parameter-rules)|
| 187.|[What is an error object?](#q-what-is-an-error-object)|
| 188.|[When you get a syntax error?](#q-when-you-get-a-syntax-error)|
| 189.|[What are the different error names from error object?](#q-what-are-the-different-error-names-from-error-object)|
| 190.|[What are the various statements in error handling?](#q-what-are-the-various-statements-in-error-handling)|
| 191.|[What are the two types of loops in javascript?](#q-what-are-the-two-types-of-loops-in-javascript)|
| 192.|[What is an Intl object?](#q-what-is-an-intl-object)|
| 193.|[How do you perform language specific date and time formatting?](#q-how-do-you-perform-language-specific-date-and-time-formatting)|
| 194.|[What is an Iterator?](#q-what-is-an-iterator)|
| 195.|[What is a decorator?](#q-what-is-a-decorator)|
| 196.|[What are the properties of Intl object?](#q-what-are-the-properties-of-intl-object)|
| 197.|[What is an Unary operator?](#q-what-is-an-unary-operator)|
| 198.|[How do you sort elements in an array?](#q-how-do-you-sort-elements-in-an-array)|
| 199.|[What is the purpose of compareFunction while sorting arrays?](#q-what-is-the-purpose-of-comparefunction-while-sorting-arrays)|
| 200.|[How do you reversing an array?](#q-how-do-you-reversing-an-array)|
| 201.|[How do you find min and max value in an array?](#q-how-do-you-find-min-and-max-value-in-an-array)|
| 202.|[How do you find min and max values without Math functions?](#q-how-do-you-find-min-and-max-values-without-math-functions)|
| 203.|[What is an empty statement and purpose of it?](#q-what-is-an-empty-statement-and-purpose-of-it)|
| 204.|[How do you get meta data of a module?](#q-how-do-you-get-meta-data-of-a-module)|
| 205.|[What is a comma operator?](#q-what-is-a-comma-operator)|
| 206.|[What is the advantage of a comma operator?](#q-what-is-the-advantage-of-a-comma-operator)|
| 207.|[Explain event delegation](#q-explain-event-delegation)
| 208.|[Explain how prototypal inheritance works](#q-explain-how-prototypal-inheritance-works)
| 209.|[Example of Prototypal Inheritance](#q-example-of-prototypal-inheritance)
| 210.|[What do you think of AMD vs CommonJS?](#q-what-do-you-think-of-amd-vs-commonjs)|
| 211.|[Explain why the following doesn't work as an IIFE: `function foo(){ }();`. What needs to be changed to properly make it an IIFE?](#q-explain-why-the-following-doesn-t-work-as-an-iife-function-foo-what-needs-to-be-changed-to-properly-make-it-an-iife)|
| 212.|[What's the difference between a variable that is: `null`, `undefined` or undeclared? How would you go about checking for any of these states?](#q-what-s-the-difference-between-a-variable-that-is-null-undefined-or-undeclared-how-would-you-go-about-checking-for-any-of-these-states)|
| 213.|[Can you describe the main difference between a `.forEach` loop and a `.map()` loop and why you would pick one versus the other?](#q-can-you-describe-the-main-difference-between-a-foreach-loop-and-a-map-loop-and-why-you-would-pick-one-versus-the-other)|
| 214.|[What's a typical use case for anonymous functions?](#q-what-s-a-typical-use-case-for-anonymous-functions)|
| 215.|[How do you organize your code? (module pattern, classical inheritance?)](#q-how-do-you-organize-your-code-module-pattern-classical-inheritance)|
| 216.|[What's the difference between host objects and native objects?](#q-what-s-the-difference-between-host-objects-and-native-objects)|
| 217.|[Difference between: `function Person(){}`, `var person = Person()`, and `var person = new Person()`?](#difference-between-function-person-var-person-person-and-var-person-new-person)|
| 218.|[What's the difference between `.call` and `.apply`?](#q-what-s-the-difference-between-call-and-apply)|
| 219.|[Explain `Function.prototype.bind`.](#q-explain-functionprototypebind)|
| 220.|[When would you use `document.write()`?](#q-when-would-you-use-documentwrite)|
| 221.|[What's the difference between feature detection, feature inference, and using the UA string?](#q-what-s-the-difference-between-feature-detection-feature-inference-and-using-the-ua-string)|
| 222.|[Explain Ajax in as much detail as possible.](#q-explain-ajax-in-as-much-detail-as-possible)
| 223.|[What are the advantages and disadvantages of using Ajax?](#q-what-are-the-advantages-and-disadvantages-of-using-ajax)|
| 224.|[Explain how JSONP works (and how it's not really Ajax).](#q-explain-how-jsonp-works-and-how-it-s-not-really-ajax)|
| 225.|[What's the difference between an "attribute" and a "property"?](#q-what-s-the-difference-between-an-attribute-and-a-property)|
| 226.|[Why is extending built-in JavaScript objects not a good idea?](#q-why-is-extending-built-in-javascript-objects-not-a-good-idea)|
| 227.|[Difference between document `load` event and document `DOMContentLoaded` event?](#q-difference-between-document-load-event-and-document-domcontentloaded-event)|
| 228.|[What is the difference between `==` and `===`?](#q-what-is-the-difference-between-and)|
| 229.|[Explain the same-origin policy with regards to JavaScript.](#q-explain-the-same-origin-policy-with-regards-to-javascript)
| 230.|[Why is it called a Ternary expression, what does the word "Ternary" indicate?](#q-why-is-it-called-a-ternary-expression-what-does-the-word-ternary-indicate)|
| 231.|[What is `"use strict";`? What are the advantages and disadvantages to using it?](#q-what-is-use-strict-what-are-the-advantages-and-disadvantages-to-using-it)|
| 232.|[Why is it, in general, a good idea to leave the global scope of a website as-is and never touch it?](#q-why-is-it-in-general-a-good-idea-to-leave-the-global-scope-of-a-website-as-is-and-never-touch-it)|
| 233.|[Why would you use something like the `load` event? Does this event have disadvantages? Do you know any alternatives, and why would you use those?](#q-why-would-you-use-something-like-the-load-event-does-this-event-have-disadvantages-do-you-know-any-alternatives-and-why-would-you-use-those)|
| 234.|[What is the extent of your experience with Promises and/or their polyfills?](#q-what-is-the-extent-of-your-experience-with-promises-and-or-their-polyfills)|
| 235.|[What are the pros and cons of using Promises instead of callbacks?](#q-what-are-the-pros-and-cons-of-using-promises-instead-of-callbacks)|
| 236.|[What are some of the advantages/disadvantages of writing JavaScript code in a language that compiles to JavaScript?](#q-what-are-some-of-the-advantages-disadvantages-of-writing-javascript-code-in-a-language-that-compiles-to-javascript)|
| 237.|[What tools and techniques do you use for debugging JavaScript code?](#q-what-tools-and-techniques-do-you-use-for-debugging-javascript-code)|
| 238.|[What language constructions do you use for iterating over object properties and array items?](#q-what-language-constructions-do-you-use-for-iterating-over-object-properties-and-array-items)|
| 239.|[Explain the difference between mutable and immutable objects.](#q-explain-the-difference-between-mutable-and-immutable-objects)
| 240.|[What is an example of an immutable object in JavaScript?](#q-what-is-an-example-of-an-immutable-object-in-javascript)|
| 241.|[How can you achieve immutability in your own code?](#q-how-can-you-achieve-immutability-in-your-own-code)|
| 242.|[Explain the difference between synchronous and asynchronous functions.](#q-explain-the-difference-between-synchronous-and-asynchronous-functions)
| 243.|[What is event loop? What is the difference between call stack and task queue?](#q-what-is-event-loop-what-is-the-difference-between-call-stack-and-task-queue)|
| 244.|[Explain the differences on the usage of `foo` between `function foo() {}` and `var foo = function() {}`](#q-explain-the-differences-on-the-usage-of-foo-between-function-foo-and-var-foo-function)|
| 245.|[What are the differences between variables created using `let`, `var` or `const`?](#q-what-are-the-differences-between-variables-created-using-let-var-or-const)|
| 246.|[What is the definition of a higher-order function?](#q-what-is-the-definition-of-a-higher-order-function)|
| 247.|[Can you give an example of a curry function and why this syntax offers an advantage?](#q-can-you-give-an-example-of-a-curry-function-and-why-this-syntax-offers-an-advantage)|
| 248.|[How can you share code between files?](#q-how-can-you-share-code-between-files)|
| 249.|[Why you might want to create static class members?](#q-why-you-might-want-to-create-static-class-members)|
| 250.|[What's the difference between `undefined` and `not defined` in JavaScript](#q-what-s-the-difference-between-undefined-and-not-defined-in-javascript)
| 251.|[For which value of `x` the results of the following statements are not the same?](#q-for-which-value-of-x-the-results-of-the-following-statements-are-not-the-same)|
| 252.|[What is the drawback of declaring methods directly in JavaScript objects?](#q-what-is-the-drawback-of-declaring-methods-directly-in-javascript-objects)|
| 253.|[What is “closure” in javascript? Can you provide an example?](#q-what-is-closure-in-javascript-can-you-provide-an-example)|
| 254.|[Write a mul function which will work properly when invoked with following syntax.](#q-write-a-mul-function-which-will-work-properly-when-invoked-with-following-syntax)
| 255.|[How to empty an array in JavaScript?](#q-how-to-empty-an-array-in-javascript)|
| 256.|[How to check if an object is an array or not?](#q-how-to-check-if-an-object-is-an-array-or-not)|
| 257.|[What is `undefined x 1` in JavaScript](#q-what-is-undefined-x-in-javascript)
| 258.|[What is the difference between declaring a function in the formats listed below?](#q-what-is-the-difference-between-declaring-a-function-in-the-formats-listed-below)|
| 259.|[In which case the function definition is not hoisted in JavaScript?](#q-in-which-case-the-function-definition-is-not-hoisted-in-javascript)|
| 260.|[What’s the difference between `typeof` and `instanceof`?](#q-what-s-the-difference-between-typeof-and-instanceof)|
| 261.|[Calculate the length of the associative array](#q-calculate-the-length-of-the-associative-array)
| 262.|[Difference between `Function`, `Method` and `Constructor` calls in JavaScript.](#q-difference-between-function-method-and-constructor-calls-in-javascript)
| 263.|[What are Service Workers and when can you use them?](#q-what-are-service-workers-and-when-can-you-use-them)|
| 264.|[What is the difference between a method and a function in javascript?](#q-what-is-the-difference-between-a-method-and-a-function-in-javascript)|
| 265.|[What is IIFE (Immediately Invoked Function Expression) and how it can be useful?](#q-what-is-iife-immediately-invoked-function-expression-and-how-it-can-be-useful)|
| 266.|[Describe Singleton Pattern In JavaScript](#q-describe-singleton-pattern-in-javascript)
| 267.|[Singleton Design Pattern Implementation](#q-singleton-design-pattern-implementation)
| 268.|[Write a function called deepClone which takes an object and creates a object copy of it.](#q-write-a-function-called-deepclone-which-takes-an-object-and-creates-a-object-copy-of-it)
| 269.|[Best way to detect `undefined` object property in JavaScript.](#q-best-way-to-detect-undefined-object-property-in-javascript)
| 270.|[Write a function called `Clone` which takes an object and creates a object copy of it but not copy deep property of object.](#q-write-a-function-called-clone-which-takes-an-object-and-creates-a-object-copy-of-it-but-not-copy-deep-property-of-object)
| 271.|[What are promises and how they are useful?](#q-what-are-promises-and-how-they-are-useful)|
| 272.|[How to check whether a key exist in a JavaScript object or not.](#q-how-to-check-whether-a-key-exist-in-a-javascript-object-or-not)
| 273.|[What is NaN, why do we need it, and when can it break the page?](#q-what-is-nan-why-do-we-need-it-and-when-can-it-break-the-page)|
| 274.|[How to check if the value of a variable in an array?](#q-how-to-check-if-the-value-of-a-variable-in-an-array)|
| 275.|[Best way to detect reference values of any type in JavaScript?](#q-best-way-to-detect-reference-values-of-any-type-in-javascript)|
| 276.|[How does Object.create method works JavaScript?](#q-how-does-objectcreate-method-works-javascript)|
| 277.|[How to use constructor functions for inheritance in JavaScript?](#q-how-to-use-constructor-functions-for-inheritance-in-javascript)|
| 278.|[How we can prevent modification of object in JavaScript?.](#q-how-we-can-prevent-modification-of-object-in-javascript)|
| 279.|[Write a log function which will add prefix `(your message)` to every message you log using console.log ?](#q-write-a-log-function-which-will-add-prefix-your-message-to-every-message-you-log-using-consolelog)|
| 280.|[Write a function which will test string as a literal and as an object ?](#q-write-a-function-which-will-test-string-as-a-literal-and-as-an-object)|
| 281.|[What is typical use case for anonymous function in JavaScript ?](#q-what-is-typical-use-case-for-anonymous-function-in-javascript)|
| 282.|[How to set a default parameter value ?](#q-how-to-set-a-default-parameter-value)|
| 283.|[Write code for merge two JavaScript Object dynamically.](#q-write-code-for-merge-two-javascript-object-dynamically)
| 284.|[What is non-enumerable property in JavaScript and how you can create one?](#q-what-is-non-enumerable-property-in-javascript-and-how-you-can-create-one)|
| 285.|[What is Function binding ?](#q-what-is-function-binding)|
| 286.|[Passing values by reference vs by value](#passing-values-by-reference-vs-by-value)
| 287.|[Explain event delegation](#q-explain-event-delegation)
| 288.|[Explain how `this` works in JavaScript](#q-explain-how-this-works-in-javascript)
| 289.|[Explain how prototypal inheritance works](#q-explain-how-prototypal-inheritance-works)
| 290.|[Example of Prototypal Inheritance](#q-example-of-prototypal-inheritance)
| 291.|[What do you think of AMD vs CommonJS?](#q-what-do-you-think-of-amd-vs-commonjs)
| 292.|[Explain why the following doesn't work as an IIFE: `function foo(){ }();`. What needs to be changed to properly make it an IIFE?](#q-explain-why-the-following-doesn-t-work-as-an-iife-function-foo-what-needs-to-be-changed-to-properly-make-it-an-iife)
| 293.|[What's the difference between a variable that is: `null`, `undefined` or undeclared? How would you go about checking for any of these states?](#q-what-s-the-difference-between-a-variable-that-is-null-undefined-or-undeclared-how-would-you-go-about-checking-for-any-of-these-states)
| 294.|[What is a closure, and how/why would you use one?](#q-what-is-a-closure-and-how-why-would-you-use-one)
| 295.|[Can you describe the main difference between a `.forEach` loop and a `.map()` loop and why you would pick one versus the other?](#q-can-you-describe-the-main-difference-between-a-foreach-loop-and-a-map-loop-and-why-you-would-pick-one-versus-the-other)
| 296.|[What's a typical use case for anonymous functions?](#q-what-s-a-typical-use-case-for-anonymous-functions)
| 297.|[How do you organize your code? (module pattern, classical inheritance?)](#q-how-do-you-organize-your-code-module-pattern-classical-inheritance)
| 298.|[What's the difference between host objects and native objects?](#q-what-s-the-difference-between-host-objects-and-native-objects)
| 290.|[Difference between: `function Person(){}`, `var person = Person()`, and `var person = new Person()`?](#q-difference-between-function-person-var-person-person-and-var-person-new-person)|
| 300.|[What's the difference between `.call` and `.apply`?](#q-what-s-the-difference-between-call-and-apply)
| 301.|[Explain `Function.prototype.bind`.](#q-explain-functionprototypebind)
| 302.|[When would you use `document.write()`?](#q-when-would-you-use-documentwrite)
| 303.|[What's the difference between feature detection, feature inference, and using the UA string?](#q-what-s-the-difference-between-feature-detection-feature-inference-and-using-the-ua-string)
| 304.|[Explain Ajax in as much detail as possible.](#q-explain-ajax-in-as-much-detail-as-possible)
| 305.|[What are the advantages and disadvantages of using Ajax?](#q-what-are-the-advantages-and-disadvantages-of-using-ajax)
| 306.|[Explain how JSONP works (and how it's not really Ajax).](#q-explain-how-jsonp-works-and-how-it-s-not-really-ajax)
| 307.|[Have you ever used JavaScript templating? If so, what libraries have you used?](#q-have-you-ever-used-javascript-templating-if-so-what-libraries-have-you-used)|
| 308.|[Explain "hoisting".](#q-explain-hoisting)|
| 309.|[What's the difference between an "attribute" and a "property"?](#q-what-s-the-difference-between-an-attribute-and-a-property)
| 310.|[Why is extending built-in JavaScript objects not a good idea?](#q-why-is-extending-built-in-javascript-objects-not-a-good-idea)
| 311.|[Difference between document `load` event and document `DOMContentLoaded` event?](#q-difference-between-document-load-event-and-document-domcontentloaded-event)
| 312.|[What is the difference between `==` and `===`?](#q-what-is-the-difference-between-and)
| 313.|[Explain the same-origin policy with regards to JavaScript.](#q-explain-the-same-origin-policy-with-regards-to-javascript)
| 314.|[Why is it called a Ternary expression, what does the word "Ternary" indicate?](#q-why-is-it-called-a-ternary-expression-what-does-the-word-ternary-indicate)
| 315.|[Why is it, in general, a good idea to leave the global scope of a website as-is and never touch it?](#q-why-is-it-in-general-a-good-idea-to-leave-the-global-scope-of-a-website-as-is-and-never-touch-it)
| 316.|[Why would you use something like the `load` event? Does this event have disadvantages? Do you know any alternatives, and why would you use those?](#q-why-would-you-use-something-like-the-load-event-does-this-event-have-disadvantages-do-you-know-any-alternatives-and-why-would-you-use-those)
| 317.|[What is the extent of your experience with Promises and/or their polyfills?](#q-what-is-the-extent-of-your-experience-with-promises-and-or-their-polyfills)
| 318.|[What are the pros and cons of using Promises instead of callbacks?](#q-what-are-the-pros-and-cons-of-using-promises-instead-of-callbacks)
| 319.|[What tools and techniques do you use for debugging JavaScript code?](#q-what-tools-and-techniques-do-you-use-for-debugging-javascript-code)
| 320.|[What language constructions do you use for iterating over object properties and array items?](#q-what-language-constructions-do-you-use-for-iterating-over-object-properties-and-array-items)
| 321.|[Explain the difference between mutable and immutable objects.](#q-explain-the-difference-between-mutable-and-immutable-objects)
| 322.|[What is an example of an immutable object in JavaScript?](#q-what-is-an-example-of-an-immutable-object-in-javascript)
| 323.|[How can you achieve immutability in your own code?](#q-how-can-you-achieve-immutability-in-your-own-code)
| 324.|[Explain the difference between synchronous and asynchronous functions.](#q-explain-the-difference-between-synchronous-and-asynchronous-functions)
| 325.|[What is event loop? What is the difference between call stack and task queue?](#q-what-is-event-loop-what-is-the-difference-between-call-stack-and-task-queue)
| 326.|[Explain the differences on the usage of `foo` between `function foo() {}` and `var foo = function() {}`](#q-explain-the-differences-on-the-usage-of-foo-between-function-foo-and-var-foo-function)
| 327.|[What is the definition of a higher-order function?](#q-what-is-the-definition-of-a-higher-order-function)
| 328.|[Can you give an example of a curry function and why this syntax offers an advantage?](#q-can-you-give-an-example-of-a-curry-function-and-why-this-syntax-offers-an-advantage)
| 329.|[How can you share code between files?](#q-how-can-you-share-code-between-files)
| 330.|[Why you might want to create static class members?](#q-why-you-might-want-to-create-static-class-members)
| 331.|[What is JSON and its common operations?](#q-what-is-json-and-its-common-operations)|
| 332.|[What is the purpose of array slice method?](#q-what-is-the-purpose-of-array-slice-method)|
| 333.|[What is the purpose of array splice method?](#q-what-is-the-purpose-of-array-splice-method)|
| 334.|[What is the difference between slice and splice?](#q-what-is-the-difference-between-slice-and-splice)|
| 335.|[How do you compare Object and Map?](#q-how-do-you-compare-object-and-map)|
| 336.|[How do you redeclare variables in switch block without an error?](#qhow-do-you-redeclare-variables-in-switch-block-without-an-error)|
| 337.|[How to Create and trigger events in javascript?](#q-how-to-create-and-trigger-events-in-javascript)|
| 338.|[What is difference between window.frames window.parent and window.top in JavaScript?](#q-What-is-difference-between-window-frames-window-parent-and-window-top-in-javascript)|
| 339.|[In JavaScript, what is the difference between var x = 1 and x = 1?](#q-in-javascript-what-is-the-difference-between-var-x-1-and-x-1)|
| 340.|[What is Associative Array? How do we use it?](#q-what-is-associative-array-how-do-we-use-it)|
| 341.|[What is difference between Classic Inheritance and Prototypical Inheritance?](#q-what-is-difference-between-classic-inheritance-and-prototypical-inheritance)|
| 342.|[What is difference between private variable, public variable and static variable? How we achieve this in JS?](#q-what-is-difference-between-private-variable-public-variable-and-static-variable-how-we-achieve-this-in-js)|
| 343.|[How to add and remove properties to object in run time?](#q-how-to-add-and-remove-properties-to-object-in-run-time)|
| 344.|[How to extend built-in objects?](#q-how-to-extend-built-in-objects)|
| 345.|[Why extending array is bad idea?](#q-why-extending-array-is-bad-idea)|
| 346.|[What is difference between browser detection and feature detection?](#q-what-is-difference-between-browser-detection-and-feature-detection)|
| 347.|[What is difference between Graceful Degradation and Progressive Enhancement?](#q-what-is-difference-between-graceful-degradation-and-progressive-enhancement)|
| 348.|[In JavaScript, why is the “this” operator inconsistent?](#q-in-javascript-why-is-the-this-operator-inconsistent)|
| 349.|[How accidental closures might cause memory leaks in IE?](#q-how-accidental-closures-might-cause-memory-leaks-in-ie)|
| 350.|[What unit testing framework do you use? and why?](#q-what-unit-testing-framework-do-you-use-and-why)|
| 351.|[Explain the difference between Object.freeze() vs const?](#q-explain-the-difference-between-objectfreeze-vs-const)|
| 352.|[What is generator in JS?](#q-what-is-generator-in-js)|
| 353.|[Describe the Revealing Module Pattern in javascript?](#q-describe-the-revealing-module-pattern-in-javascript)|
| 354.|[Compare Async-Await and Generators usage to achive same functionality?](#q-compare-async-await-and-generators-usage-to-achive-same-functionality)|
| 355.|[Explain escape() and unescape() functions?](#q-explain-escape-and-unescape-functions)|
| 356.|[What do you understand by Screen objects?](#q-what-do-you-understand-by-screen-objects)|
| 357.|[How will you remove duplicates from a JS array?](#q-how-will-you-remove-duplicates-from-a-js-array)|
| 358.|[Explain NEGATIVE_INFINITY in JavaScript?](#q-explain-negative-infinity-in-javascript)|
| 359.|[What do you understand by ViewState and SessionState?](#q-what-do-you-understand-by-viewstate-and-sessionstate)|
| 360.|[Explain var self = this in JavaScript](#q-explain-var-self-this-in-javascript)|
| 361.|[What is difference between append() vs appendChild()?](#q-what-is-difference-between-append-vs-appendchild)|
| 362.|[What is difference between null vs undefined?](#q-what-is-difference-between-null-vs-undefined)|
| 363.|[What is difference between array[] vs object()?](#q-what-is-difference-between-array-vs-object)|
| 364.|[What is difference between async() or defer() keyword in JavaScript?](#q-what-is-difference-between-async-or-defer-keyword-in-javascript)|
| 365.|[What is difference between async() and await() in ajax?](#q-what-is-difference-between-async-and-await-in-ajax)|
| 366.|[What is request header in javascript?](#q-what-is-request-header-in-javascript)|
| 367.|[What is rendering in JavaScript?](#q-what-is-rendering-in-javascript)|
| 368.|[Define the various types of errors which occur in JavaScript programming language?](#q-define-the-various-types-of-errors-which-occur-in-javascript-programming-language)|
| 369.|[What is unshift() method in JavaScript?](#q-what-is-unshift-method-in-javascript)|
| 370.|[What is the difference between HTMLCollection and NodeList?](#q-what-is-the-difference-between-htmlcollection-and-nodelist)|
| 371.|[What is the difference between firstChild and firstElementChild?](#q-what-is-the-difference-between-firstchild-and-firstelementchild)|
| 372.|[Name the two functions that are used to create an HTML element dynamically.](#q-name-the-two-functions-that-are-used-to-create-an-html-element-dynamically)
| 373.|[What is callback() function in javascript?](#q-what-is-callback-function-in-javascript)|
| 374.|[What is shallow copy and deep copy in javascript?](#q-what-is-shallow-copy-and-deep-copy-in-javascript)|
| 375.|[What is difference between stoppropagation vs stopimmediatepropagation vs preventdefault in javascript?](#q-what-is-difference-between-stoppropagation-vs-stopimmediatepropagation-vs-preventdefault-in-javascript)|
| 376.|[Explain array methods join(), pop(), push(), shift(), unshift(), concat(), map(), filter(), reduce(), reduceRight(), every(), some(), indexOf(), lastIndexOf(), find(), findIndex(), includes(), set() ](#q-explain-array-methods-join-pop-push-shift-unshift-concat-map-filter-reduce-reduceright-every-some-indexof-lastindexof-find-findindex-includes-set)|
| 377.|[What is variable shadowing javascript?](#q-what-is-variable-shadowing-javascript)|
| 378.|[When to use function declarations and expressions in JavaScript?](#q-when-to-use-function-declarations-and-expressions-in-javascript)|
| 379.|[How to create captcha using javascript?](#q-how-to-create-captcha-using-javascript)|
| 380.|[How to avoid callback hell in javascript?](#q-how-to-avoid-callback-hell-in-javascript)|
| 381.|[Why is eval() considered evil and dangerous?](#q-why-is-eval-considered-evil-and-dangerous)|
| 382.|[What is the difference between encryption and hashing?](#q-what-is-the-difference-between-encryption-and-hashing)|
| 383.|[What is Proxies and Reflection in JavaScript?](#q-what-is-proxies-and-reflection-in-javascript)|
...
employee.displayName(); // "Alex"
```
In the example above, `emp1` is created with it's own value for name, so calling **displayName()** method will display `"John"` instead of `"Alex"`.
