...
|Sl.No| Questions                                                                         |
|-----|-----------------------------------------------------------------------------------|
| 01.|[What is difference between document.getElementById() and document.uerySelector()?](#q-what-is-difference-between-documentgetelementbyid-and-documentueryselector)|
...
- It can return a value: 
  ...
  ```
- You do not have to surround the function declaration into parens, although it's the most common way to define IIFE. Instead you can use any of the following forms: 
