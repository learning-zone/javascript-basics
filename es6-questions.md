...
## Q1. List out important features of es6?
...
## Q2. ES6 Template Literals offer a lot of flexibility in generating strings, can you give an example?
...
## Q3. What is the benefit of using the arrow syntax for a method in a constructor?
...
## Q4. What are fat arrow functions? When you should not use arrow functions in ES6?
...
## Q5. How does await and async works in es6?
...
## Q6. What are the benefits of using arrow function over es5 function?
...
## Q7. What are the differences between ES6 class and ES5 function constructors?
...
## Q8. What are the benefits of using spread syntax and how is it different from rest syntax?
...
## Q9. What are the differences between variables created using `let`, `var` or `const`?
...
## Q11. What is the Temporal Dead Zone in ES6?
...
let aLet = 2;
```
## Q12. What is the difference between ES6 Map and WeakMap?
**Map**  
...
## Q13. What are default values in destructuring assignment?
...
console.log(z); // 6
```
## Q14. How do you swap variables using Destructuring Assignment?
```javascript
var x = 10, y = 20;
...
console.log(y); // 10
```
## Q15. What is the output of below spread operator array?
```javascript
[...'John']
```
**Output**:  ['J', 'o', 'h', 'n']  
...
## Q17. What is a trampoline function? What is it used for? 
...
## Q18. What is the difference between Set and WeakSet in ES6?
...
## Q19. What is difference between fetch() and XMLHttpRequest() in JavaScript?
...
## Q20. What is the difference between Promise and AJAX?
...
## Q21. What is use of Proxies in es6?
...
#### Q22. How could you make sure a const value is garbage collected?
